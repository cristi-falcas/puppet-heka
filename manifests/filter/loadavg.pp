# Graphs the load average and process count data. Expects to receive messages containing fields entitled 1MinAvg, 5MinAvg,
# 15MinAvg, and NumProcesses, such as those generated by the Linux Load Average Decoder.
#
# === Parameters:
#
...
#
### Load Average Filter Parameters
#
