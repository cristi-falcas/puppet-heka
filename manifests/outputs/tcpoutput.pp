...
#                                Defaults to 512MiB. Value cannot be zero, if zero is specified the default will instead be used.
#
...
#                                Cannot currently be combined with TLS connections.
#
# $encoder::                     Specifies which of the registered encoders should be used for converting Heka messages to
#                                binary data that is sent out over the TCP connection.
